...
private:
    ...
    float Price; // price = price entered, fill_price = price received
    int Size;
    string Ticker;
    ...
    int getOrderNum(){ return OrderNumber; }
    OrdType getOrderType() {return OrderType; }
    int getSize(){return Size;}
    Term getTerm(){return OrderTerm;}
    Status getStatus() {return OrderStatus; }
    milliseconds getTime(){ return timestamp;}
    Action getAction(){return OrderAction;}
